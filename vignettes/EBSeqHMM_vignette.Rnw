...
Here we identified 60 genes as DE under 5\% target FDR.
...
Here we identified 123 isoforms as DE under 5\% target FDR.
...
<<eval=TRUE, fig=TRUE>>=
par(mfrow=c(2,2))
for(i in 1:4)PlotExp(GeneNormData, Conditions, Name=GeneOfInterest[i])
@
